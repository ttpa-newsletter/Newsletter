    ...
    try {
        ...
        if (visitDayElement) {
            visitDayElement.textContent =
                summary.total_visit_days ?? 0;
        }

        if (totalReadingElement) {
            totalReadingElement.textContent =
                formatReadingTime(
                    summary.total_active_seconds ?? 0
                );
        }
        ...
        if (averageReadingElement) {
            averageReadingElement.textContent =
                formatReadingTime(
                    summary.average_active_seconds ?? 0
                );
        }
...
/* ---------------------------------------------------------
   RENDER DASHBOARD PAGE-WISE VISITORS
   --------------------------------------------------------- */
...
function renderDashboardVisitorTable(pageVisits) {
    ...
    pageVisits.forEach(function (page) {
        ...
        row.appendChild(visitorCell);
        row.appendChild(visitDayCell);
        row.appendChild(totalReadingCell);
        row.appendChild(averageReadingCell);
...
/* ---------------------------------------------------------
   RENDER DASHBOARD PAGE-WISE REACTIONS
   --------------------------------------------------------- */

function renderDashboardReactionTable(pageReactions) {
    ...
    pageReactions.forEach(function (page) {
